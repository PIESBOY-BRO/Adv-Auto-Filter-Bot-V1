...
class Translation(object):
    ...
    START_TEXT = """<b>Hey {}!!</b>
<i>𝐚𝐦 𝐭𝐡𝐞 𝐨𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐀𝐮𝐭𝐨 𝐅𝐢𝐥𝐭𝐞𝐫 𝐁𝐨𝐭 𝐨𝐟 𝐭𝐡𝐞 "𝐌𝐨𝐯𝐢𝐞 𝐖𝐨𝐫𝐥𝐝" 𝐠𝐫𝐨𝐮𝐩....🤖

↯ 𝐓𝐨 𝐠𝐞𝐭 𝐭𝐡𝐞 𝐦𝐨𝐯𝐢𝐞𝐬 𝐲𝐨𝐮 𝐧𝐞𝐞𝐝 ↯

 ⓵: 𝐆𝐨 𝐭𝐨 𝐨𝐮𝐫 𝐠𝐫𝐨𝐮𝐩 𝐚𝐧𝐝 𝐫𝐞𝐪𝐮𝐞𝐬𝐭 𝐭𝐡𝐞 𝐧𝐚𝐦𝐞 𝐨𝐟 𝐭𝐡𝐞 𝐦𝐨𝐯𝐢𝐞 𝐭𝐡𝐞𝐫𝐞.
 ⓶: 𝐓𝐡𝐞𝐧 𝐜𝐥𝐢𝐜𝐤 𝐨𝐧 𝐭𝐡𝐞 𝐥𝐢𝐧𝐤 𝐰𝐞 𝐩𝐫𝐨𝐯𝐢𝐝𝐞.
 ⓷: 𝐓𝐡𝐞𝐧 𝐜𝐥𝐢𝐜𝐤 𝐨𝐧 𝐭𝐡𝐞 "𝐒𝐓𝐀𝐑𝐓" 𝐛𝐮𝐭𝐭𝐨𝐧.

⇃𝗖𝗹𝗶𝗰𝗸 𝗼𝗻 𝘁𝗵𝗲 𝗯𝘂𝘁𝘁𝗼𝗻 𝗯𝗲𝗹𝗼𝘄 𝘁𝗼 𝗷𝗼𝗶𝗻 𝗼𝘂𝗿 𝗴𝗿𝗼𝘂𝗽𝘀⇂..⚡️
@Movie_World_00
</i>"""    
...
<b>➥ Source Code</b> : <i><a href="https://github.com/PIESBOY-BRO/Adv-Auto-Filter-Bot-V1">Click Me</a></i>
"""
